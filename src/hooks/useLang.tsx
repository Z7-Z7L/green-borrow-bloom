...
const translations = {
  en: {
    ...
    signInDesc: "Sign in to borrow and track your books",
    createAccountDesc: "Create an account to start borrowing books",
    password: "Password",
    ...
    signOut: "Sign Out",
    loginToBorrow: "Sign in to borrow",
    ...
    holdUntilMsg: "You cannot borrow books until",
    lateWarning: "You have {count} late return(s). More than 1 late return will result in a 1-day account hold.",
  },
  ar: {
    ...
    signInDesc: "سجّل الدخول لاستعارة وتتبع كتبك",
    createAccountDesc: "أنشئ حساباً لبدء استعارة الكتب",
